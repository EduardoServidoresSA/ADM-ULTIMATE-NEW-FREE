...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/EduardoServidoresSA/ADM-ULTIMATE-NEW-FREE/master/trans &> /dev/null
msg -bar2
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   ...
   wget -O /root/versao https://raw.githubusercontent.com/EduardoServidoresSA/ADM-ULTIMATE-NEW-FREE/master/versao &> /dev/null
   inst_components
